...
Power.mat <- betapower(mu0 = 0.56, sd0 = 0.255,
                       mu1.start = .60, mu1.end = .75, mu1.by = .05,
                       ss.start = 30, ss.end = 50, ss.by = 5,
                       trials = 500, seed = 617201501, 
...
plot.betapower(Power.mat, link.type = "logit", by = "mu1")
```
...
samplesize(mu0=0.56, sd0=0.255, 
                       mu1.start = 0.65, mu1.end = 0.65, mu1.by = 0, 
                       power.start = 0.8, power.end = 0.8, power.by = 0, 
                       trials=200, seed=617201501, link.type = c("logit","loglog","wilcoxon"))
```
...
SS.mat <- samplesize(mu0=0.56, sd0=0.255, 
                       mu1.start = 0.65, mu1.end = 0.75, mu1.by = 0.05, 
...
```{r, fig.show='hold', fig.width = 9, fig.height =6}
plot.samplesize(SS.mat, link.type = c("logit","loglog","wilcoxon"))
```
